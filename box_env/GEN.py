...
for T in range(200000):
    ...
    '''
    act_inp = np.append(ot2_part, head)
    # act_inp = act_inp.reshape((1,149))
    act_out = modelx.predict(act_inp.reshape((1,149)))
    newdelX, newdelY = act_out[0,0]/delV , act_out[0,1]/delV
    xnew = newdelX + x_hist[-1]
    ynew = newdelY + y_hist[-1]
    '''
    ...
    if T%1000==0:
        ...
        with open('traj_GEN_new.pk1', 'wb') as f:
            pickle.dump(d, f)
